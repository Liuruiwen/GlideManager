...
public class GlideCacheUtil {
    ...
    public static GlideCacheUtil getInstance(Context context) {
        if (inst == null) {
            inst = new GlideCacheUtil(context);
        }
        return inst;
    }
...
// BusUtil.getBus().post(new GlideCacheClearSuccessEvent());
     ...
     * 清除图片内存缓存
     */
    public boolean clearImageMemoryCache() {
        try {
    ...
    public void clearImageAllCache() {
        ...
        String ImageExternalCatchDir=mContext.getExternalCacheDir()+ ExternalPreferredCacheDiskCacheFactory.DEFAULT_DISK_CACHE_DIR;
